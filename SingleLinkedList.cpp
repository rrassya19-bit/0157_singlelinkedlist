...
int main()
{
    ...
    {
        cout << endl << "Menu";
        cout << endl << "1. Menambahkan data ke dalam list" << endl;
        ...
        case '2':
        {
            ...
            cout << endl << "Masukan nomor mahasiswa yang akan dihapus: ";
            cin >> nim;

            if (mhs.delNode(nim) == false)
                cout << endl << "Data tidak ditemukan" << endl;
            else
                cout << endl << "Data dengan nomor mahasiswa " << nim
        ...
        case '4':
        {
            ...
            cout << endl << "Masukan nomor mahasiswa yang akan dicari: ";
            cin >> nim;
